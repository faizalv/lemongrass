<template>
  <div :style="wrap">
    <!-- Logo mark -->
    <div :style="logoMark">
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Wordmark -->
    <div :style="wordmark">lemongrass</div>
