...
func New(parsers ...lang.Parser) *ReconUsecase {
	return &ReconUsecase{parsers: parsers}
}
...
// Format renders a full ProjectTree as compact structured text for model consumption.
...
// Each named package is shown with its full import + reverse-dep context.
