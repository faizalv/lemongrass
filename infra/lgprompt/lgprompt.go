...
func BuildSkillContent() string {
	return strings.Join([]string{
		...
		" OR: recon.peek <dir> -> codebase.interim <inputs> -> codebase.query <question>",
		"  One load, many queries. Not chained codebase.search calls.",
		"",
		"After any modification:",
		" READ ANNOTATION SECTION #lg.annotate <path:sym:kind>:\"description\":return_type_or_nil:deps [|| ref2 || ...]",
		"",
		"TOOLS",
		"",
