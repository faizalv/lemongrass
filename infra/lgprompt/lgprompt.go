...
func BuildSkillContent() string {
	return strings.Join([]string{
		...
		"  You have 5 minutes to annotate them. Past halfway: warnings appear. Past deadline: all #lg.* calls block except #lg.annotate and #lg.obligation.",
		"  #lg.obligation shows what you owe and how long remains. Annotating a symbol removes it. Empty obligation resets the clock.",
		"",
		...
		"  #lg.project.stat first -- tells you annotation coverage and device tier; determines which tools to reach for this session",
		...
		"TOOLS",
		"",
		"  #lg.obligation                                    annotation debt: unexplored/stale symbols you touched; blocks after 5 min",
