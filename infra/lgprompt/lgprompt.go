...
func BuildSkillContent() string {
	return strings.Join([]string{
		...
		"  recon.peek <dir> -> recon.search <concept> -> recon.peruse <path:sym:kind> -> Read if needed",
		"",
		"Finding exact code or a known identifier:",
		"  codebase.search <pattern> [path] -> Read <path> offset+limit for full context",
		"",
		"Understanding behaviour or flow across files:",
		"  recon.peek <dir> -> codebase.interim <inputs> -> codebase.query <question>",
		"  One load, many queries. Not chained codebase.search calls.",
		"",
