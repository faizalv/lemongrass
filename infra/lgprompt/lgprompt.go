...
func BuildSkillContent() string {
	return strings.Join([]string{
		...
		"  What has the project already learned? -> #lg.knowledge.labels, follow up on anything relevant",
		"  What lives where? -> #lg.recon.peek on areas that seem relevant, or browse with #lg.codebase.ls",
		"  Form a picture of the project before you act. Explore, then respond.",
		"",
		"USE CASES",
		"",
		"Entering an unfamiliar area:",
		"  recon.peek <dir> -> recon.search <concept> -> recon.peruse <path:sym:kind> -> system.read if needed",
		"",
		"Finding exact code or a known identifier:",
		"  codebase.search <pattern> [path] -> system.read.confirm <path> N-M for full context",
		"",
		"Understanding how something works across files:",
		"  codebase.fl <pattern> [path] to locate -> codebase.interim <inputs> -> codebase.query <question>",
		"",
		...
		"  #lg.system.read <path>                            inspect file; warns if >150 lines or >10k chars",
		"  #lg.system.read.confirm <path> [N-M]              deliver unconditionally; N-M = 1-indexed line range",
		"",
		"ANNOTATION",
		"",
		"  " + CmdAnnotate,
